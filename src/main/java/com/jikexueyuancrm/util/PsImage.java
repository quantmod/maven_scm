...
public class PsImage {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	PsImage  psImage   =new PsImage(file);
    	
    	//psImage.rotate(270);
    	
    //	psImage.clip(0,0,600,600);
    	psImage.scale(15000, 10000);
        File outPut=new File("e:\\", "2.jpg");
    	ImageIO.write(psImage.dealedImage, "jpg", outPut); // 保存图片
